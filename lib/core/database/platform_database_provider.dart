...
class PlatformDatabaseProvider {
  static final PlatformDatabaseProvider _instance = PlatformDatabaseProvider._internal();
  ...
  // Schools operations
  Future<int> insertSchool(Map<String, dynamic> school) => _provider.insertSchool(school);
  ...
  Future<int> updateSchool(int id, Map<String, dynamic> school) => _provider.updateSchool(id, school);
  Future<int> deleteSchool(int id) => _provider.deleteSchool(id);

  // Students operations
  Future<int> insertStudent(Map<String, dynamic> student) => _provider.insertStudent(student);
  ...
  Future<List<Map<String, dynamic>>> getStudentsWithSchoolInfo() => _provider.getStudentsWithSchoolInfo();
  Future<List<Map<String, dynamic>>> getStudentsBySchool(int schoolId) => _provider.getStudentsBySchool(schoolId);
  Future<int> updateStudent(int id, Map<String, dynamic> student) => _provider.updateStudent(id, student);
  Future<int> deleteStudent(int id) => _provider.deleteStudent(id);

  // Settings operations
  Future<void> saveSetting(String key, String value) => _provider.saveSetting(key, value);
