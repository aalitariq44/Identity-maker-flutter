...
class AppLocalizations {
  ...
  String get idCreation => _localizedValues[locale.languageCode]!['idCreation']!;
  String get studentsManagement => _localizedValues[locale.languageCode]!['studentsManagement']!;
  String get templateManagement => _localizedValues[locale.languageCode]!['templateManagement']!;
  ...
  String get recentExports => _localizedValues[locale.languageCode]!['recentExports']!;
  ...
  String get studentName => _localizedValues[locale.languageCode]!['studentName']!;
  String get studentBirthDate => _localizedValues[locale.languageCode]!['studentBirthDate']!;
  String get studentGrade => _localizedValues[locale.languageCode]!['studentGrade']!;
  String get studentSchool => _localizedValues[locale.languageCode]!['studentSchool']!;
  String get studentPhoto => _localizedValues[locale.languageCode]!['studentPhoto']!;
  String get studentId => _localizedValues[locale.languageCode]!['studentId']!;
  String get studentClass => _localizedValues[locale.languageCode]!['studentClass']!;
  ...
  String get editSchool => _localizedValues[locale.languageCode]!['editSchool']!;
  String get deleteSchool => _localizedValues[locale.languageCode]!['deleteSchool']!;
  String get schoolNameArabic => _localizedValues[locale.languageCode]!['schoolNameArabic']!;
  String get schoolNameEnglish => _localizedValues[locale.languageCode]!['schoolNameEnglish']!;
  String get schoolAddress => _localizedValues[locale.languageCode]!['schoolAddress']!;
  String get schoolPhone => _localizedValues[locale.languageCode]!['schoolPhone']!;
  String get schoolPrincipal => _localizedValues[locale.languageCode]!['schoolPrincipal']!;
  String get schoolLogo => _localizedValues[locale.languageCode]!['schoolLogo']!;

  // إدارة القوالب
  String get templates => _localizedValues[locale.languageCode]!['templates']!;
  String get addTemplate => _localizedValues[locale.languageCode]!['addTemplate']!;
  String get editTemplate => _localizedValues[locale.languageCode]!['editTemplate']!;
  String get deleteTemplate => _localizedValues[locale.languageCode]!['deleteTemplate']!;
  String get templateName => _localizedValues[locale.languageCode]!['templateName']!;
  String get templateWidth => _localizedValues[locale.languageCode]!['templateWidth']!;
  String get templateHeight => _localizedValues[locale.languageCode]!['templateHeight']!;
  String get templateOrientation => _localizedValues[locale.languageCode]!['templateOrientation']!;
  ...
  String get transparency => _localizedValues[locale.languageCode]!['transparency']!;
  ...
  String get selectStudents => _localizedValues[locale.languageCode]!['selectStudents']!;
  String get selectTemplate => _localizedValues[locale.languageCode]!['selectTemplate']!;
  String get preview => _localizedValues[locale.languageCode]!['preview']!;
  String get exportSuccess => _localizedValues[locale.languageCode]!['exportSuccess']!;
  String get exportError => _localizedValues[locale.languageCode]!['exportError']!;
  ...
  String get selectFile => _localizedValues[locale.languageCode]!['selectFile']!;
  String get invalidFile => _localizedValues[locale.languageCode]!['invalidFile']!;
  String get confirmDelete => _localizedValues[locale.languageCode]!['confirmDelete']!;

  // التحقق
  String get fieldRequired => _localizedValues[locale.languageCode]!['fieldRequired']!;
  ...
  // إضافية
  String get totalStudents => _localizedValues[locale.languageCode]!['totalStudents']!;
  String get totalSchools => _localizedValues[locale.languageCode]!['totalSchools']!;
  String get totalTemplates => _localizedValues[locale.languageCode]!['totalTemplates']!;
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    ...
    'en': {
      ...
      'appDescription': 'A Flutter application for designing and generating student identity cards',
      'home': 'Home',
